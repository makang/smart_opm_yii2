    ...
    <div class="col-xs-12">
        ...
        <form class="form-horizontal" method="post" role="form" action="/<?=Yii::$app->controller->id;?>/save">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" value="<?=($row['booking_system_fee']/100)?>" class="col-xs-1 col-sm-1" name="booking_system_fee" />&nbsp;元
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" value="<?=($row['open_system_fee']/100)?>" class="col-xs-1 col-sm-1" name="open_system_fee" />&nbsp;元
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" value="<?=($row['cinema_fee']/100)?>" class="col-xs-1 col-sm-1" name="cinema_fee" />&nbsp;元
                </div>
            </div>
                    ...
                    foreach($suitStatus as $k=>$v){
                        ...
                        if($k==$row['has_suit']){
                            ...
                            <label style="padding-left:10px">
                                <input class="" type="radio" checked name="has_suit" value="<?= $k;?>">
            ...
            <div class="clearfix form-actions">
                <div class="col-md-offset-3 col-md-9">
                    <span id="selectedCinema">
                        <input type="hidden" name="cinema_no[]" value="<?=$row['cinema_no'];?>">
                    </span>
