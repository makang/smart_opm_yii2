                    ...
                    <div id="sample-table-2_length" class="dataTables_length">
                        ...
                        <span class="input-icon align-middle" style="width: 200px">
                            ...
                            <select class="width-100 chosen-select" name="status">
                                  <option value="all" <?php if(!empty($_REQUEST['status']) || $_REQUEST['status']=='all') echo 'selected';?>全部状态</option>
                                 <?php
                                 foreach($dataStatus as $k=>$v){
                                     echo '<option value="'.$k.'" '.((!empty($_REQUEST['status']) && $_REQUEST['status']==$k)?'selected':'').'>'.$v.'</option>';                                 }
                                 ?>
                            </select>
                        </span>
