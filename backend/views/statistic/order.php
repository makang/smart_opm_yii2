        ...
        <div class="table-responsive">
                    ...
                    <div id="sample-table-2_length" class="dataTables_length">
                        ...
                        <?php $form = ActiveForm::begin([
                         ...
                         <span class="input-icon align-middle">
                            ...
                            <input type="text" id="datepickers_start" name="start_date" class="search-query" placeholder="开始日期" value="<?= !empty($_REQUEST['start_date'])?$_REQUEST['start_date']:"";?>"/>
                        </span>
                         <span class="input-icon align-middle">
                            <i class="icon-calendar"></i>
                            <input type="text" id="datepickers_end" name="end_date" class="search-query" placeholder="结束日期" value="<?= !empty($_REQUEST['end_date'])?$_REQUEST['end_date']:"";?>"/>
                        </span>
            ...
            <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    ['label'=>'订单额','value'=>'total_fee'],
                    ['label'=>'会员出票数','value'=>'member_num'],
                    ['label'=>'服务费','value'=>'total_fee'],
