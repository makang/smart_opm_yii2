                    ...
                    <div class="tabbable">
                            ...
                            <li class="li-new-mail pull-right">
                                <a data-toggle="tab" href="#write" data-target="write" class="btn-new-mail" id="submit">
                                    <span class="btn bt1n-small btn-purple no-border">
                                        ...
                                        <span class="bigger-110 submit" >新建活动</span>
                                    </span>
                                </a>
                            </li><!-- ./li-new-mail -->
                        ...
                        <div class="tab-content no-border no-padding">
                            ...
                            <div class="tab-pane in active" id="info">
                                <?php  echo $this->render('copy_info',['discountInfo'=>$discountInfo]); ?>
                            </div><!-- /.tab-pane -->


                            <div class="tab-pane " id="time">
                                <?php  echo $this->render('copy_time',['discountInfo'=>$discountInfo]); ?>
                            </div>

                            <div class="tab-pane " id="price">
                                <?php  echo $this->render('copy_price',['discountInfo'=>$discountInfo]); ?>
                            </div><!-- /.tab-pane -->

                            <div class="tab-pane" id="ticket">
                                <?php  echo $this->render('copy_ticket',['discountInfo'=>$discountInfo]); ?>
                            </div><!-- /.tab-pane -->
                            <!-- /.tab-pane -->
                        </div><!-- /.tab-content -->
                    </div><!-- /.tabbable -->
