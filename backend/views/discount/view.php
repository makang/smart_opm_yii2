                    ...
                    <div class="tabbable">
                        ...
                        <div class="tab-content no-border no-padding">
                            ...
                            <div class="tab-pane in active" id="info">
                                <?php  echo $this->render('view_info',['discountInfo'=>$discountInfo]); ?>
                            </div><!-- /.tab-pane -->


                            <div class="tab-pane " id="time">
                                <?php  echo $this->render('view_time',['discountInfo'=>$discountInfo]); ?>
                            </div>

                            <div class="tab-pane " id="price">
                                <?php  echo $this->render('view_price',['discountInfo'=>$discountInfo]); ?>
                            </div><!-- /.tab-pane -->

                            <div class="tab-pane" id="ticket">
                                <?php  echo $this->render('view_ticket',['discountInfo'=>$discountInfo]); ?>
                            </div><!-- /.tab-pane -->
                            <!-- /.tab-pane -->
                        </div><!-- /.tab-content -->
                    </div><!-- /.tabbable -->
